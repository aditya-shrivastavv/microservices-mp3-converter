...
wsl -d Ubuntu-22.04 -u root -e env ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i inventory.ini --private-key /mnt/e/projects/microservices-project-mp3-converter/keys/accesskey /mnt/e/projects/microservices-project-mp3-converter/playbooks/main.yaml
